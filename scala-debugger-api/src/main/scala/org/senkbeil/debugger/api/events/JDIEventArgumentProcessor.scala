...
import org.senkbeil.debugger.api.events.data.{JDIEventDataProcessor, JDIEventDataResult, JDIEventDataUnknownError}
import org.senkbeil.debugger.api.events.filters.JDIEventFilterProcessor
