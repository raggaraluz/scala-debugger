package org.senkbeil.debugger.api.requests.filters.processors

import com.sun.jdi.ReferenceType
import com.sun.jdi.request._
import org.senkbeil.debugger.api.requests.filters.{JDIRequestFilterProcessor, JDIRequestFilter, ClassReferenceFilter}
...
class ClassReferenceFilterProcessor(
  ...
  override val argument: JDIRequestFilter = classReferenceFilter
}
