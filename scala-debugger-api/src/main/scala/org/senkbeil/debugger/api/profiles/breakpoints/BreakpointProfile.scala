package org.senkbeil.debugger.api.profiles.breakpoints
...
trait BreakpointProfile {
  ...
  ): CloseablePipeline[BreakpointEvent, BreakpointEvent]
  ...
  def onBreakpointWithData(
    ...
    lineNumber: Int,
    extraArguments: JDIArgument*
  ): CloseablePipeline[BreakpointEventAndData, BreakpointEventAndData]
}
