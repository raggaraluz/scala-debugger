package org.senkbeil.debugger.api.events.data.requests

import org.senkbeil.debugger.api.events.JDIEventProcessor
import org.senkbeil.debugger.api.events.data.JDIEventDataRequest
import org.senkbeil.debugger.api.events.data.processors.CustomPropertyDataRequestProcessor
