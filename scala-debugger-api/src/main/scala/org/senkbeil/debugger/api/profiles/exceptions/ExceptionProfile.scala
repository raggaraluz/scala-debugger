package org.senkbeil.debugger.api.profiles.exceptions
...
trait ExceptionProfile {
  ...
  ): CloseablePipeline[ExceptionEvent, ExceptionEvent]
  ...
  def onExceptionWithData(
    ...
    notifyUncaught: Boolean,
    extraArguments: JDIArgument*
  ): CloseablePipeline[ExceptionEventAndData, ExceptionEventAndData]
