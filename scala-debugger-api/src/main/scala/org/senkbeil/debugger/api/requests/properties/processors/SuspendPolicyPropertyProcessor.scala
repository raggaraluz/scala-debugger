package org.senkbeil.debugger.api.requests.properties.processors

import com.sun.jdi.request._
import org.senkbeil.debugger.api.requests.properties.{JDIRequestPropertyProcessor, JDIRequestProperty, SuspendPolicyProperty}
