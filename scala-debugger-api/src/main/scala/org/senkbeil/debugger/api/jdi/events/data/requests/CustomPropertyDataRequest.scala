package org.senkbeil.debugger.api.jdi.events.data.requests

import org.senkbeil.debugger.api.jdi.events.JDIEventProcessor
import org.senkbeil.debugger.api.jdi.events.data.JDIEventDataRequest
import org.senkbeil.debugger.api.jdi.events.data.processors.CustomPropertyDataRequestProcessor
