 ...
 */
class PureExceptionEventInfoProfile(
  ...
  _location = _location
) with ExceptionEventInfoProfile {
  /**
   ...
   *         to Java
   */
  override def toJavaInfo: ExceptionEventInfoProfile = {
   ...
   */
  override def catchLocation: Option[LocationInfoProfile] = {
   ...
   */
  override def exception: ObjectInfoProfile = {
