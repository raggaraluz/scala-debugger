...
/**
 * Represents a java implementation of a class loader profile that adds no
...
) extends JavaObjectInfo(scalaVirtualMachine, infoProducer, _classLoaderReference)(
