...
/**
 * Represents a java implementation of a thread group profile that adds no
...
) extends JavaObjectInfo(scalaVirtualMachine, infoProducer, _threadGroupReference)(
