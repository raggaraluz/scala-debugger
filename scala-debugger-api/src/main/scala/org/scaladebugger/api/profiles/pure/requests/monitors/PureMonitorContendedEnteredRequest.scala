 ...
 */
trait PureMonitorContendedEnteredRequest extends MonitorContendedEnteredRequest {
  ...
  protected def newMonitorContendedEnteredRequestHelper() = {
    ...
    new RequestHelper[E, EI, RequestArgs, CounterKey](
      ...
      _newEventInfo = (s, event, jdiArgs) => {
        eventProducer.newDefaultMonitorContendedEnteredEventInfoProfile(s, event, jdiArgs: _*)
      },
