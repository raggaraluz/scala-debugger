...
/**
 * Represents a java implementation of a class object profile that adds no
 ...
 */
class JavaClassObjectInfo(
  override val scalaVirtualMachine: ScalaVirtualMachine,
  private val _infoProducer: InfoProducer,
...
) extends JavaObjectInfo(scalaVirtualMachine, _infoProducer, _classObjectReference)(
  _virtualMachine = _virtualMachine,
  _referenceType = _referenceType
) with ClassObjectInfo {
  /**
   ...
   */
  override def reflectedType: ReferenceTypeInfo = {
