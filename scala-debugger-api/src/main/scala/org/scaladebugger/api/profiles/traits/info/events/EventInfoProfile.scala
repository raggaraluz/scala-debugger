...
import org.scaladebugger.api.profiles.traits.info.CommonInfoProfile
 ...
 */
trait EventInfoProfile extends CommonInfoProfile {
  /**
   ...
   */
  def tryToAccessWatchpointEvent: Try[AccessWatchpointEventInfoProfile] = {
  ...
  def toAccessWatchpointEvent: AccessWatchpointEventInfoProfile
   ...
   *         the event, otherwise a failure
   */
  def tryToBreakpointEvent: Try[BreakpointEventInfoProfile] = {
   ...
   */
  @throws[AssertionError]
  def toBreakpointEvent: BreakpointEventInfoProfile
   ...
   *         the event, otherwise a failure
   */
  def tryToClassPrepareEvent: Try[ClassPrepareEventInfoProfile] = {
   ...
   */
  @throws[AssertionError]
  def toClassPrepareEvent: ClassPrepareEventInfoProfile
   ...
   *         the event, otherwise a failure
   */
  def tryToClassUnloadEvent: Try[ClassUnloadEventInfoProfile] = {
   ...
   */
  @throws[AssertionError]
  def toClassUnloadEvent: ClassUnloadEventInfoProfile
   ...
   *         the event, otherwise a failure
   */
  def tryToExceptionEvent: Try[ExceptionEventInfoProfile] = {
   ...
   */
  @throws[AssertionError]
  def toExceptionEvent: ExceptionEventInfoProfile
   ...
   *         the event, otherwise a failure
   */
  def tryToLocatableEvent: Try[LocatableEventInfoProfile] = {
   ...
   */
  @throws[AssertionError]
  def toLocatableEvent: LocatableEventInfoProfile
   ...
   *         the event, otherwise a failure
   */
  def tryToMethodEntryEvent: Try[MethodEntryEventInfoProfile] = {
   ...
   */
  @throws[AssertionError]
  def toMethodEntryEvent: MethodEntryEventInfoProfile
   ...
   *         the event, otherwise a failure
   */
  def tryToMethodExitEvent: Try[MethodExitEventInfoProfile] = {
   ...
   */
  @throws[AssertionError]
  def toMethodExitEvent: MethodExitEventInfoProfile
   ...
   *         the event, otherwise a failure
   */
  def tryToModificationWatchpointEvent: Try[ModificationWatchpointEventInfoProfile] = {
   ...
   *         the event, otherwise a failure
   */
  def tryToMonitorContendedEnteredEvent: Try[MonitorContendedEnteredEventInfoProfile] = {
   ...
   */
  @throws[AssertionError]
  def toMonitorContendedEnteredEvent: MonitorContendedEnteredEventInfoProfile
   ...
   *         the event, otherwise a failure
   */
  def tryToMonitorContendedEnterEvent: Try[MonitorContendedEnterEventInfoProfile] = {
   ...
   */
  @throws[AssertionError]
  def toMonitorContendedEnterEvent: MonitorContendedEnterEventInfoProfile
   ...
   *         the event, otherwise a failure
   */
  def tryToMonitorWaitedEvent: Try[MonitorWaitedEventInfoProfile] = {
   ...
   */
  @throws[AssertionError]
  def toMonitorWaitedEvent: MonitorWaitedEventInfoProfile
   ...
   *         the event, otherwise a failure
   */
  def tryToMonitorWaitEvent: Try[MonitorWaitEventInfoProfile] = {
   ...
   */
  @throws[AssertionError]
  def toMonitorWaitEvent: MonitorWaitEventInfoProfile
   ...
   *         the event, otherwise a failure
   */
  def tryToStepEvent: Try[StepEventInfoProfile] = {
    Try(toStepEvent)
  }
   ...
   */
  @throws[AssertionError]
  def toStepEvent: StepEventInfoProfile
   ...
   *         the event, otherwise a failure
   */
  def tryToThreadDeathEvent: Try[ThreadDeathEventInfoProfile] = {
   ...
   */
  @throws[AssertionError]
  def toThreadDeathEvent: ThreadDeathEventInfoProfile
   ...
   *         the event, otherwise a failure
   */
  def tryToThreadStartEvent: Try[ThreadStartEventInfoProfile] = {
   ...
   */
  @throws[AssertionError]
  def toThreadStartEvent: ThreadStartEventInfoProfile
   ...
   *         the event, otherwise a failure
   */
  def tryToVMDeathEvent: Try[VMDeathEventInfoProfile] = {
    Try(toVMDeathEvent)
  }
   ...
   */
  @throws[AssertionError]
  def toVMDeathEvent: VMDeathEventInfoProfile
   ...
   *         the event, otherwise a failure
   */
  def tryToVMDisconnectEvent: Try[VMDisconnectEventInfoProfile] = {
   ...
   */
  @throws[AssertionError]
  def toVMDisconnectEvent: VMDisconnectEventInfoProfile
   ...
   *         the event, otherwise a failure
   */
  def tryToVMStartEvent: Try[VMStartEventInfoProfile] = {
    Try(toVMStartEvent)
  }
   ...
   */
  @throws[AssertionError]
  def toVMStartEvent: VMStartEventInfoProfile
   ...
   *         the event, otherwise a failure
   */
  def tryToWatchpointEvent: Try[WatchpointEventInfoProfile] = {
