...
import org.scaladebugger.api.profiles.traits.info.events.{MonitorEvent, MonitorWaitedEventInfo}
import org.scaladebugger.api.virtualmachines.ScalaVirtualMachine

/**
 * Represents a java implementation of a monitor waited event info
 ...
 */
class JavaMonitorWaitedEventInfo(
   ...
   *         to Java
   */
  override def toJavaInfo: MonitorWaitedEventInfo = {
    val jep = infoProducer.eventProducer.toJavaInfo
    jep.newMonitorWaitedEventInfo(
      scalaVirtualMachine = scalaVirtualMachine,
