...
import org.senkbeil.debugger.api.jdi.requests.filters._
import org.senkbeil.debugger.api.jdi.requests.properties.{EnabledProperty, CustomProperty, SuspendPolicyProperty}
