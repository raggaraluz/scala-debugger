  ...
  with OneInstancePerTest with MockFactory with JDIMockHelpers
{
  ...
  private val modificationWatchpointManager = new ModificationWatchpointManager(
  ...
  describe("ModificationWatchpointManager") {
    ...
    describe("#modificationWatchpointRequestList") {
      it("should contain all modification watchpoint requests in the form of field stored in the manager") {
        ...
        val modificationWatchpointManager = new ModificationWatchpointManager(
          mockEventRequestManager,
          mockClassManager
        )
        ...
        modificationWatchpointManager.modificationWatchpointRequestList should
