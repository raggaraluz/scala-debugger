...
import org.senkbeil.debugger.api.requests.filters._
import org.senkbeil.debugger.api.requests.properties.{CustomProperty, EnabledProperty, SuspendPolicyProperty}
