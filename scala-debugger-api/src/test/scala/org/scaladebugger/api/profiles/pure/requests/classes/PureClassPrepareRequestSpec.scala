...
class PureClassPrepareRequestSpec extends ParallelMockFunSpec with JDIMockHelpers {
  ...
  private class TestPureClassPrepareRequest(
    private val customTestRequestHelper: Option[CustomTestRequestHelper] = None
  ) extends PureClassPrepareRequest {
  ...
  private val pureClassPrepareProfile =
    new TestPureClassPrepareRequest(Some(mockRequestHelper))
  ...
  describe("PureClassPrepareRequest") {
    describe("for custom request helper") {
      describe("#_newRequestId") {
        it("should return a new id each time") {
          val pureClassPrepareProfile = new TestPureClassPrepareRequest()
    ...
    describe("#classPrepareRequests") {
      it("should include all active requests") {
        ...
        val pureClassPrepareProfile = new Object with PureClassPrepareRequest {
          override protected val classPrepareManager = mockClassPrepareManager
          override protected val eventManager: EventManager = mockEventManager
          override protected val infoProducer: InfoProducer = mockInfoProducer
          override protected val scalaVirtualMachine: ScalaVirtualMachine = mockScalaVirtualMachine
