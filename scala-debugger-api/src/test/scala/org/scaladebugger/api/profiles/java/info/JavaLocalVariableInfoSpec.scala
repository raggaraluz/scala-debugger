...
class JavaLocalVariableInfoSpec extends ParallelMockFunSpec
{
  ...
  private val javaLocalVariableInfoProfile = new JavaLocalVariableInfo(
  ...
  describe("JavaLocalVariableInfo") {
    describe("#toJavaInfo") {
      it("should return a new instance of the Java profile representation") {
        ...
        val actual = javaLocalVariableInfoProfile.toJavaInfo
    ...
    describe("#isJavaInfo") {
      it("should return true") {
        ...
        val actual = javaLocalVariableInfoProfile.isJavaInfo
    ...
    describe("#toJdiInstance") {
      it("should return the JDI instance this profile instance represents") {
        ...
        val actual = javaLocalVariableInfoProfile.toJdiInstance
    ...
    describe("#name") {
      it("should return the local variable's name") {
        ...
        val actual = javaLocalVariableInfoProfile.name
    ...
    describe("#typeName") {
      it("should return the local variable's type name") {
        ...
        val actual = javaLocalVariableInfoProfile.typeName
    ...
    describe("#typeInfo") {
      it("should should return a new type info profile wrapping the type") {
        ...
        val actual = javaLocalVariableInfoProfile.`type`
    ...
    describe("#isLocal") {
      it("should return true") {
        ...
        val actual = javaLocalVariableInfoProfile.isLocal
    ...
    describe("#isArgument") {
      it("should return true if is an argument") {
        ...
        val actual = javaLocalVariableInfoProfile.isArgument
    ...
    describe("#isField") {
      it("should return false") {
        ...
        val actual = javaLocalVariableInfoProfile.isField
    ...
    describe("#setValueFromInfo") {
      it("should be able to set the value using the info") {
        ...
        javaLocalVariableInfoProfile.setValueFromInfo(expected) should be (expected)
      }
    }
    ...
    describe("#toValueInfo") {
      it("should return a wrapper around the value of the localVariable") {
        ...
        val javaLocalVariableInfoProfile = new JavaLocalVariableInfo(
          mockScalaVirtualMachine,
          mockInfoProducerProfile,
          mockFrameInfoProfile,
          mockLocalVariable,
        ...
        javaLocalVariableInfoProfile.toValueInfo should be (expected)
      }
    }
  }
}
