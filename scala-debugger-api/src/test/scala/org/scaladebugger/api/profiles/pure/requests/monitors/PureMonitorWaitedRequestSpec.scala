...
class PureMonitorWaitedRequestSpec extends ParallelMockFunSpec with JDIMockHelpers {
  ...
  private class TestPureMonitorWaitedRequest(
    private val customTestRequestHelper: Option[CustomTestRequestHelper] = None
  ) extends PureMonitorWaitedRequest {
  ...
  private val pureMonitorWaitedProfile =
    new TestPureMonitorWaitedRequest(Some(mockRequestHelper))
  ...
  describe("PureMonitorWaitedRequest") {
    describe("for custom request helper") {
      describe("#_newRequestId") {
        it("should return a new id each time") {
          val pureMonitorWaitedProfile = new TestPureMonitorWaitedRequest()
    ...
    describe("#monitorWaitedRequests") {
      it("should include all active requests") {
        ...
        val pureMonitorWaitedProfile = new Object with PureMonitorWaitedRequest {
          override protected val monitorWaitedManager = mockMonitorWaitedManager
          override protected val eventManager: EventManager = mockEventManager
          override protected val infoProducer: InfoProducer = mockInfoProducer
          override protected val scalaVirtualMachine: ScalaVirtualMachine = mockScalaVirtualMachine
