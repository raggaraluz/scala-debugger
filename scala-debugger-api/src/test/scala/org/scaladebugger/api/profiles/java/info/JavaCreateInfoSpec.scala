...
class JavaCreateInfoSpec extends ParallelMockFunSpec with JDIMockHelpers
{
  ...
  describe("JavaCreateInfoProfile") {
    describe("#createRemotely(AnyVal)") {
      it("should create and wrap a mirrored boolean value in a value info profile") {
        ...
        val actual = javaCreateInfoProfile.createRemotely(testValue)
    ...
    describe("#createRemotely(String)") {
      it("should create and wrap a mirrored string value in a value info profile") {
        ...
        val actual = javaCreateInfoProfile.createRemotely(testString)
