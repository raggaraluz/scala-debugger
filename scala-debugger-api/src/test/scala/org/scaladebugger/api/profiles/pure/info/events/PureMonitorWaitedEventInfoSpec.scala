...
class PureMonitorWaitedEventInfoSpec extends test.ParallelMockFunSpec {
  ...
  private val pureMonitorWaitedEventInfoProfile = new PureMonitorWaitedEventInfo(
  ...
  describe("PureMonitorWaitedEventInfo") {
    describe("#toJavaInfo") {
