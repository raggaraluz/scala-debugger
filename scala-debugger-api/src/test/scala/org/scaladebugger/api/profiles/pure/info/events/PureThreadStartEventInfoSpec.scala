...
class PureThreadStartEventInfoSpec extends test.ParallelMockFunSpec {
  ...
  private val pureThreadStartEventInfoProfile = new PureThreadStartEventInfo(
  ...
  describe("PureThreadStartEventInfo") {
    describe("#toJavaInfo") {
