...
class JavaVMDeathRequestSpec extends ParallelMockFunSpec with JDIMockHelpers {
  ...
  private val javaVMDeathProfile =
    new TestJavaVMDeathRequest(Some(mockRequestHelper))

  describe("JavaVMDeathRequest") {
    describe("for custom request helper") {
      describe("#_newRequestId") {
        it("should return a new id each time") {
          val javaVMDeathProfile = new TestJavaVMDeathRequest()
          val requestHelper = javaVMDeathProfile.newVMDeathRequestHelper()
    ...
    describe("#tryGetOrCreateVMDeathRequestWithData") {
      it("should use the request helper's request and event pipeline methods") {
        ...
        val actual = javaVMDeathProfile.tryGetOrCreateVMDeathRequest(
    ...
    describe("#vmDeathRequests") {
      it("should include all active requests") {
        ...
        val javaVMDeathProfile = new Object with JavaVMDeathRequest {
          override protected val vmDeathManager = mockVMDeathManager
          override protected val eventManager: EventManager = mockEventManager
          override protected val infoProducer: InfoProducer = mockInfoProducer
          override protected val scalaVirtualMachine: ScalaVirtualMachine = mockScalaVirtualMachine
        ...
        val actual = javaVMDeathProfile.vmDeathRequests
    ...
    describe("#removeVMDeathRequestWithArgs") {
      it("should return None if no requests exists") {
        ...
        val actual = javaVMDeathProfile.removeVMDeathRequestWithArgs()
    ...
    describe("#removeAllVMDeathRequests") {
      it("should return empty if no requests exists") {
        ...
        val actual = javaVMDeathProfile.removeAllVMDeathRequests()
    ...
    describe("#isVMDeathRequestWithArgsPending") {
      it("should return false if no requests exist") {
        ...
        val actual = javaVMDeathProfile.isVMDeathRequestWithArgsPending()
