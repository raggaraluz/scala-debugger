...
class JavaVMStartRequestSpec extends ParallelMockFunSpec with JDIMockHelpers
{
  ...
  private val javaVMStartProfile =
    new TestJavaVMStartRequest(Some(mockRequestHelper))

  describe("JavaVMStartRequest") {
    describe("for custom request helper") {
      describe("#_newRequestId") {
        it("should return a new id each time") {
          val javaVMStartProfile = new TestJavaVMStartRequest()
          val requestHelper = javaVMStartProfile.newVMStartRequestHelper()
      ...
      describe("#_newEventInfo") {
        it("should create new event info for the specified args") {
          ...
          (mockEventProducer.newDefaultVMStartEventInfo _)
    ...
    describe("#tryGetOrCreateVMStartRequestWithData") {
      it("should use the request helper's request and event pipeline methods") {
        ...
        val actual = javaVMStartProfile.tryGetOrCreateVMStartRequest(
