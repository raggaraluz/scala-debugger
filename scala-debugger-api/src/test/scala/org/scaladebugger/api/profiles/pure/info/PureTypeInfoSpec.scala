...
class PureTypeInfoSpec extends test.ParallelMockFunSpec
{
  private val mockScalaVirtualMachine = mock[ScalaVirtualMachine]
  private val mockInfoProducerProfile = mock[InfoProducer]
  private val mockType = mock[Type]
  private val pureTypeInfoProfile = new PureTypeInfo(
  ...
  describe("PureTypeInfo") {
    describe("#toJavaInfo") {
      it("should return a new instance of the Java profile representation") {
        ...
        (mockInfoProducerProfile.newTypeInfoProfile _)
          .expects(mockScalaVirtualMachine, mockType)
          .returning(expected).once()

        val actual = pureTypeInfoProfile.toJavaInfo
    ...
    describe("#isJavaInfo") {
      it("should return true") {
        ...
        val actual = pureTypeInfoProfile.isJavaInfo
    ...
    describe("#name") {
      ...
      it("should return \"null\" if the type is null") {
        ...
        val pureTypeInfoProfile = new PureTypeInfo(
