...
class PureVMStartEventInfoProfileSpec extends test.ParallelMockFunSpec {
  ...
  private val pureVMStartEventInfoProfile = new PureVMStartEventInfoProfile(
  ...
  describe("PureVMStartEventInfoProfile") {
    describe("#toJavaInfo") {
