...
import org.scaladebugger.api.profiles.traits.info.events.{EventInfoProducerProfile, VMStartEventInfoProfile}
...
class PureVMStartProfileSpec extends test.ParallelMockFunSpec with JDIMockHelpers
{
  ...
  private type EI = VMStartEventInfoProfile
