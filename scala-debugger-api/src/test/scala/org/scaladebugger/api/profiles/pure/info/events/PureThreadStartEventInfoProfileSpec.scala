...
class PureThreadStartEventInfoProfileSpec extends test.ParallelMockFunSpec {
  ...
  private val pureThreadStartEventInfoProfile = new PureThreadStartEventInfoProfile(
  ...
  describe("PureThreadStartEventInfoProfile") {
    describe("#toJavaInfo") {
      it("should return a new instance of the Java profile representation") {
        ...
        (mockEventInfoProducer.newThreadStartEventInfoProfile(
        ...
        val actual = pureThreadStartEventInfoProfile.toJavaInfo
    ...
    describe("#isJavaInfo") {
      it("should return true") {
        ...
        val actual = pureThreadStartEventInfoProfile.isJavaInfo
    ...
    describe("#toJdiInstance") {
      it("should return the JDI instance this profile instance represents") {
        ...
        val actual = pureThreadStartEventInfoProfile.toJdiInstance
    ...
    describe("#thread") {
      it("should return a new instance of the thread info profile") {
        ...
        val actual = pureThreadStartEventInfoProfile.thread
