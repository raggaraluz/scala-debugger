...
import test.InfoTestClasses.TestThreadStatusInfo

class ThreadStatusInfoSpec extends test.ParallelMockFunSpec
{
  ...
  private val threadStatusInfoProfile = new TestThreadStatusInfo {
