...
class JavaThreadInfoSpec extends ParallelMockFunSpec
{
  private val mockScalaVirtualMachine = mock[ScalaVirtualMachine]
  private val mockInfoProducerProfile = mock[InfoProducer]
  private val mockVirtualMachine = mock[VirtualMachine]
  private val mockReferenceType = mock[ReferenceType]
  private val mockNewFrameProfile = mockFunction[StackFrame, Int, FrameInfo]
  private val mockNewThreadStatusProfile = mockFunction[ThreadStatusInfo]
  private val mockNewThreadGroupProfile = mockFunction[ThreadGroupReference, ThreadGroupInfo]
  private val mockThreadReference = mock[ThreadReference]
  private val javaThreadInfoProfile = new JavaThreadInfo(
    ...
    override protected def newThreadStatusProfile(): ThreadStatusInfo =
    ...
    override protected def newFrameProfile(
      ...
      index: Int
    ): FrameInfo = mockNewFrameProfile(stackFrame, index)
  }
  ...
  describe("JavaThreadInfo") {
    describe("#toJavaInfo") {
      it("should return a new instance of the Java profile representation") {
        ...
        (mockInfoProducerProfile.newThreadInfo(
        ...
        val actual = javaThreadInfoProfile.toJavaInfo
    ...
    describe("#isJavaInfo") {
      it("should return true") {
        ...
        val actual = javaThreadInfoProfile.isJavaInfo
    ...
    describe("#toJdiInstance") {
      it("should return the JDI instance this profile instance represents") {
        ...
        val actual = javaThreadInfoProfile.toJdiInstance
    ...
    describe("#name") {
      it("should return the name of the thread") {
        ...
        val actual = javaThreadInfoProfile.name
    ...
    describe("#status") {
      it("should return a new thread status info profile") {
        val expected = mock[ThreadStatusInfo]

        mockNewThreadStatusProfile.expects().returning(expected).once()
        val actual = javaThreadInfoProfile.status
    ...
    describe("#threadGroup") {
      it("should return a new thread group info profile wrapping the thread group") {
        ...
        val actual = javaThreadInfoProfile.threadGroup
    ...
    describe("#frames()") {
      it("should return a collection of profiles wrapping the frames of the suspended thread") {
        ...
        val actual = javaThreadInfoProfile.frames
    ...
    describe("#frames(index, length)") {
      it("should return a collection of profiles wrapping the frames of the suspended thread") {
        ...
        val expected = (1 to totalFrames).map(_ => mock[FrameInfo])
        ...
        val actual = javaThreadInfoProfile.frames(index, length)
    ...
    describe("#frame") {
      it("should return a profile wrapping the frame at the specified position in the stack") {
        ...
        val actual = javaThreadInfoProfile.frame(index)
    ...
    describe("#totalFrames") {
      it("should return the total number of frames available in the stack of the suspended thread") {
        ...
        val actual = javaThreadInfoProfile.totalFrames
