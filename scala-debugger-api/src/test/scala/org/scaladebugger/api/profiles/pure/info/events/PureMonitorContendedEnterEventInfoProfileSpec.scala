...
class PureMonitorContendedEnterEventInfoProfileSpec extends test.ParallelMockFunSpec {
  ...
  private val pureMonitorContendedEnterEventInfoProfile = new PureMonitorContendedEnterEventInfoProfile(
  ...
  describe("PureMonitorContendedEnterEventInfoProfile") {
    describe("#toJavaInfo") {
