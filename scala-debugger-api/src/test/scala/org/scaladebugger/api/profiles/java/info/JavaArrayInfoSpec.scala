...
class JavaArrayInfoSpec extends ParallelMockFunSpec
{
  ...
  private val javaArrayInfoProfile = new JavaArrayInfo(
  ...
  describe("JavaArrayInfo") {
    describe("#toJavaInfo") {
      it("should return a new instance of the Java profile representation") {
        ...
        val actual = javaArrayInfoProfile.toJavaInfo
    ...
    describe("#isJavaInfo") {
      it("should return true") {
        ...
        val actual = javaArrayInfoProfile.isJavaInfo
    ...
    describe("#toJdiInstance") {
      it("should return the JDI instance this profile instance represents") {
        ...
        val actual = javaArrayInfoProfile.toJdiInstance
    ...
    describe("#typeInfo") {
      it("should should return a new array type profile wrapping the type") {
        ...
        val actual = javaArrayInfoProfile.`type`
    ...
    describe("#length") {
      it("should return the length provided by the array reference") {
        ...
        val actual = javaArrayInfoProfile.length
    ...
    describe("#value") {
      it("should return a new value profile wrapping the value at the position") {
        ...
        val javaArrayInfoProfile = new JavaArrayInfo(
          mockScalaVirtualMachine, mockInfoProducerProfile, mockArrayReference
        )(
          _virtualMachine = mockVirtualMachine,
          _referenceType = mockReferenceType
        ...
        val actual = javaArrayInfoProfile.value(0)
    ...
    describe("#values(index, totalElements)") {
      it("should return value profiles wrapping the return values") {
        ...
        val actual = javaArrayInfoProfile.values(0, 0)
    ...
    describe("#values") {
      it("should return value profiles wrapping the return values") {
        ...
        (mockArrayReference.getValues: Function0[java.util.List[Value]]).expects()
          .returning(mockValues.asJava).once()
        val actual = javaArrayInfoProfile.values
    ...
    describe("#setValueFromInfo") {
      it("should set and return the provided value at the specified position") {
        ...
        val actual = javaArrayInfoProfile.setValueFromInfo(index, expected)
    ...
    describe("#setValuesFromInfo(index, values, srcIndex, totalElements)") {
      it("should set and return the values starting from the src index to total elements") {
        val expected = Seq(mock[ValueInfo], mock[ValueInfo])

        val index = 999
        val values = mock[ValueInfo] +: expected
        val srcIndex = 1
        val totalElements = 2
        ...
        val actual = javaArrayInfoProfile.setValuesFromInfo(
          index,
          values,
          srcIndex,
          totalElements
    ...
    describe("#setValuesFromInfo(values)") {
      it("should set and return the provided values") {
        ...
        val actual = javaArrayInfoProfile.setValuesFromInfo(expected)
