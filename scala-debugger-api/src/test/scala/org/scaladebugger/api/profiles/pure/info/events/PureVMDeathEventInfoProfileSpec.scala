...
class PureVMDeathEventInfoProfileSpec extends test.ParallelMockFunSpec {
  ...
  private val pureVMDeathEventInfoProfile = new PureVMDeathEventInfoProfile(
  ...
  describe("PureVMDeathEventInfoProfile") {
    describe("#toJavaInfo") {
