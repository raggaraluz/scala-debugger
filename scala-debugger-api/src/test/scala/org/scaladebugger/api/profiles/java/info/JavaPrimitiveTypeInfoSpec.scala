...
class JavaPrimitiveTypeInfoSpec extends ParallelMockFunSpec
{
  ...
  private val leftPrimitiveTypeInfoProfile = new JavaPrimitiveTypeInfo(
    mockScalaVirtualMachine, mockInfoProducerProfile, Left(mockPrimitiveType)
  )

  private val rightPrimitiveTypeInfoProfile = new JavaPrimitiveTypeInfo(
    mockScalaVirtualMachine, mockInfoProducerProfile, Right(mockVoidType)
  )

  describe("JavaPrimitiveTypeInfo") {
    describe("#toJavaInfo") {
