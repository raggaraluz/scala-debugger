...
class JavaThreadDeathEventInfoSpec extends ParallelMockFunSpec {
  ...
  private val javaThreadDeathEventInfoProfile = new JavaThreadDeathEventInfo(
  ...
  describe("JavaThreadDeathEventInfo") {
    describe("#toJavaInfo") {
      it("should return a new instance of the Java profile representation") {
        ...
        val actual = javaThreadDeathEventInfoProfile.toJavaInfo
    ...
    describe("#isJavaInfo") {
      it("should return true") {
        ...
        val actual = javaThreadDeathEventInfoProfile.isJavaInfo
    ...
    describe("#toJdiInstance") {
      it("should return the JDI instance this profile instance represents") {
        ...
        val actual = javaThreadDeathEventInfoProfile.toJdiInstance
    ...
    describe("#thread") {
      it("should return a new instance of the thread info profile") {
        ...
        val actual = javaThreadDeathEventInfoProfile.thread
