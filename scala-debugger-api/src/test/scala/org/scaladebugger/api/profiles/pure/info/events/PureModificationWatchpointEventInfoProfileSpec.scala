...
class PureModificationWatchpointEventInfoProfileSpec extends test.ParallelMockFunSpec {
  ...
  private val pureModificationWatchpointEventInfoProfile = new PureModificationWatchpointEventInfoProfile(
  ...
  describe("PureModificationWatchpointEventInfoProfile") {
    describe("#toJavaInfo") {
