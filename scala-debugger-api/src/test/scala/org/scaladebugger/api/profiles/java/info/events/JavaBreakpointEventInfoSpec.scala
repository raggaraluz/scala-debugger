...
class JavaBreakpointEventInfoSpec extends ParallelMockFunSpec {
  ...
  private val javaBreakpointEventInfoProfile = new JavaBreakpointEventInfo(
  ...
  describe("JavaBreakpointEventInfo") {
    describe("#toJavaInfo") {
      it("should return a new instance of the Java profile representation") {
        ...
        val actual = javaBreakpointEventInfoProfile.toJavaInfo
    ...
    describe("#isJavaInfo") {
      it("should return true") {
        ...
        val actual = javaBreakpointEventInfoProfile.isJavaInfo
    ...
    describe("#toJdiInstance") {
      it("should return the JDI instance this profile instance represents") {
        ...
        val actual = javaBreakpointEventInfoProfile.toJdiInstance
