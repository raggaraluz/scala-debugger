...
class JavaExceptionEventInfoSpec extends ParallelMockFunSpec {
  ...
  private val javaExceptionEventInfoProfile = new JavaExceptionEventInfo(
  ...
  describe("JavaExceptionEventInfo") {
    describe("#toJavaInfo") {
      it("should return a new instance of the Java profile representation") {
        ...
        val actual = javaExceptionEventInfoProfile.toJavaInfo
    ...
    describe("#isJavaInfo") {
      it("should return true") {
        ...
        val actual = javaExceptionEventInfoProfile.isJavaInfo
    ...
    describe("#toJdiInstance") {
      it("should return the JDI instance this profile instance represents") {
        ...
        val actual = javaExceptionEventInfoProfile.toJdiInstance
    ...
    describe("#catchLocation") {
      it("should return Some new location profile if there is a catch location") {
        ...
        val actual = javaExceptionEventInfoProfile.catchLocation
      ...
      it("should return None if there is no catch location") {
        ...
        val javaExceptionEventInfoProfile = new JavaExceptionEventInfo(
          scalaVirtualMachine = mockScalaVirtualMachine,
          infoProducer = mockInfoProducer,
          exceptionEvent = mockExceptionEvent,
          jdiArguments = mockJdiArguments
    ...
    describe("#exception") {
      it("should return a new object info profile for the exception object") {
        ...
        val actual = javaExceptionEventInfoProfile.exception
