...
class PureClassUnloadEventInfoProfileSpec extends test.ParallelMockFunSpec {
  ...
  private val pureClassUnloadEventInfoProfile = new PureClassUnloadEventInfoProfile(
  ...
  describe("PureClassUnloadEventInfoProfile") {
    describe("#toJavaInfo") {
