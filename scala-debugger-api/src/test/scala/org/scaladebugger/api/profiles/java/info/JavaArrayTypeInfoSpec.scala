...
class JavaArrayTypeInfoSpec extends ParallelMockFunSpec
{
  ...
  private val javaArrayTypeInfoProfile = new JavaArrayTypeInfo(
  ...
  describe("JavaArrayTypeInfo") {
    describe("#toJavaInfo") {
      it("should return a new instance of the Java profile representation") {
        ...
        val actual = javaArrayTypeInfoProfile.toJavaInfo
    ...
    describe("#isJavaInfo") {
      it("should return true") {
        ...
        val actual = javaArrayTypeInfoProfile.isJavaInfo
    ...
    describe("#toJdiInstance") {
      it("should return the JDI instance this profile instance represents") {
        ...
        val actual = javaArrayTypeInfoProfile.toJdiInstance
    ...
    describe("#elementSignature") {
      it("should return the signature of the array's element") {
        ...
        val actual = javaArrayTypeInfoProfile.elementSignature
    ...
    describe("#elementTypeName") {
      it("should return the type name of the array's element") {
        ...
        val actual = javaArrayTypeInfoProfile.elementTypeName
    ...
    describe("#elementTypeInfo") {
      it("should should return a new type info profile wrapping the array element's type") {
        ...
        val actual = javaArrayTypeInfoProfile.elementType
    ...
    describe("#newInstance") {
      it("should create a new instance of the array with the specified length") {
        ...
        val actual = javaArrayTypeInfoProfile.newInstance(length)
