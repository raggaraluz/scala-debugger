...
class JavaBreakpointRequestSpec extends ParallelMockFunSpec with JDIMockHelpers
{
  ...
  private val javaBreakpointProfile =
    new TestJavaBreakpointRequest(Some(mockRequestHelper))
  ...
  describe("JavaBreakpointRequest") {
    describe("for custom request helper") {
      describe("#_newRequestId") {
        it("should return a new id each time") {
          val javaBreakpointProfile = new TestJavaBreakpointRequest()
          val requestHelper = javaBreakpointProfile.newBreakpointRequestHelper()
    ...
    describe("#tryGetOrCreateBreakpointRequestWithData") {
      it("should use the request helper's request and event pipeline methods") {
        ...
        val actual = javaBreakpointProfile.tryGetOrCreateBreakpointRequest(
          fileName,
          lineNumber,
    ...
    describe("#breakpointRequests") {
      it("should include all active requests") {
        ...
        val javaBreakpointProfile = new Object with JavaBreakpointRequest {
          override protected val breakpointManager = mockBreakpointManager
          override protected val eventManager: EventManager = mockEventManager
          override protected val infoProducer: InfoProducer = mockInfoProducer
          override protected val scalaVirtualMachine: ScalaVirtualMachine = mockScalaVirtualMachine
        ...
        val actual = javaBreakpointProfile.breakpointRequests
    ...
    describe("#removeBreakpointRequests") {
      it("should return empty if no requests exists") {
        ...
        val actual = javaBreakpointProfile.removeBreakpointRequests(
          fileName,
          lineNumber
        )
    ...
    describe("#removeBreakpointRequestWithArgs") {
      it("should return None if no requests exists") {
        ...
        val actual = javaBreakpointProfile.removeBreakpointRequestWithArgs(
          fileName,
          lineNumber
        )
    ...
    describe("#removeAllBreakpointRequests") {
      it("should return empty if no requests exists") {
        ...
        val actual = javaBreakpointProfile.removeAllBreakpointRequests()
    ...
    describe("#isBreakpointRequestPending") {
      it("should return false if no requests exist") {
        ...
        val actual = javaBreakpointProfile.isBreakpointRequestPending(
          fileName,
          lineNumber
        )
    ...
    describe("#isBreakpointRequestWithArgsPending") {
      it("should return false if no requests exist") {
        ...
        val actual = javaBreakpointProfile.isBreakpointRequestWithArgsPending(
          fileName,
          lineNumber
        )
