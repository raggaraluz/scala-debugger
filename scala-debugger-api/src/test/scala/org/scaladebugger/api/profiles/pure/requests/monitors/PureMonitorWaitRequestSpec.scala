...
class PureMonitorWaitRequestSpec extends ParallelMockFunSpec with JDIMockHelpers {
  ...
  private val pureMonitorWaitProfile =
    new TestPureMonitorWaitRequest(Some(mockRequestHelper))
  ...
  describe("PureMonitorWaitRequest") {
    describe("for custom request helper") {
      describe("#_newRequestId") {
        it("should return a new id each time") {
          val pureMonitorWaitProfile = new TestPureMonitorWaitRequest()
    ...
    describe("#monitorWaitRequests") {
      it("should include all active requests") {
        ...
        val pureMonitorWaitProfile = new Object with PureMonitorWaitRequest {
          override protected val monitorWaitManager = mockMonitorWaitManager
          override protected val eventManager: EventManager = mockEventManager
          override protected val infoProducer: InfoProducer = mockInfoProducer
          override protected val scalaVirtualMachine: ScalaVirtualMachine = mockScalaVirtualMachine
