...
class PureMonitorEventInfoProfileSpec extends test.ParallelMockFunSpec {
  ...
  private val pureMonitorEventInfoProfile = new PureMonitorEventInfoProfile(
  ...
  describe("PureMonitorEventInfoProfile") {
    describe("#toJavaInfo") {
