...
class JavaExceptionRequestSpec extends ParallelMockFunSpec with JDIMockHelpers
{
  ...
  private val javaExceptionProfile =
    new TestJavaExceptionRequest(Some(mockRequestHelper))
  ...
  describe("JavaExceptionRequest") {
      ...
      describe("#_newRequestId") {
        describe("forCatchall == false") {
          it("should return a new id each time") {
            val javaExceptionProfile = new TestJavaExceptionRequest()
            val requestHelper = javaExceptionProfile.newExceptionRequestHelper(
              forCatchall = false
            )
    ...
    describe("#tryGetOrCreateExceptionRequestWithData") {
      it("should throw an exception if the exception name is null") {
        javaExceptionProfile.tryGetOrCreateExceptionRequestWithData(
          null,
          notifyCaught = true,
          notifyUncaught = false,
      ...
      it("should use the standard request helper's request and event pipeline methods") {
        ...
        val actual = javaExceptionProfile.tryGetOrCreateExceptionRequestWithData(
          exceptionName,
          notifyCaught,
          notifyUncaught,
    ...
    describe("#tryGetOrCreateAllExceptionsRequestWithData") {
      it("should use the catchall request helper's request and event pipeline methods") {
        ...
        val actual = javaExceptionProfile.tryGetOrCreateAllExceptionsRequestWithData(
          notifyCaught,
          notifyUncaught,
          mockJdiRequestArgs ++ mockJdiEventArgs: _*
        ).get
    ...
    describe("#exceptionRequests") {
      it("should include all active requests") {
        ...
        val javaExceptionProfile = new Object with JavaExceptionRequest {
          override protected val exceptionManager = mockExceptionManager
          override protected val eventManager: EventManager = mockEventManager
          override protected val infoProducer: InfoProducer = mockInfoProducer
          override protected val scalaVirtualMachine: ScalaVirtualMachine = mockScalaVirtualMachine
        ...
        val actual = javaExceptionProfile.exceptionRequests
    ...
    describe("#removeOnlyAllExceptionsRequests") {
      it("should return empty if no requests exists") {
        ...
        val actual = javaExceptionProfile.removeOnlyAllExceptionsRequests()
    ...
    describe("#removeOnlyAllExceptionsRequestWithArgs") {
      it("should return None if no requests exists") {
        ...
        val actual = javaExceptionProfile.removeOnlyAllExceptionsRequestWithArgs(
          notifyCaught,
          notifyUncaught
        )
    ...
    describe("#removeExceptionRequests") {
      it("should return empty if no requests exists") {
        ...
        val actual = javaExceptionProfile.removeExceptionRequests(
          exceptionName
        )
    ...
    describe("#removeExceptionRequestWithArgs") {
      it("should return None if no requests exists") {
        ...
        val actual = javaExceptionProfile.removeExceptionRequestWithArgs(
          exceptionName,
          notifyCaught,
          notifyUncaught
        )
    ...
    describe("#removeAllExceptionRequests") {
      it("should return empty if no requests exists") {
        ...
        val actual = javaExceptionProfile.removeAllExceptionRequests()
    ...
    describe("#isAllExceptionsRequestPending") {
      it("should return false if no requests exist") {
        ...
        val actual = javaExceptionProfile.isAllExceptionsRequestPending
    ...
    describe("#isAllExceptionsRequestWithArgsPending") {
      it("should return false if no requests exist") {
        ...
        val actual = javaExceptionProfile.isAllExceptionsRequestWithArgsPending(
          notifyCaught,
          notifyUncaught,
          extraArguments: _*
        )
    ...
    describe("#isExceptionRequestPending") {
      it("should return false if no requests exist") {
        ...
        val actual = javaExceptionProfile.isExceptionRequestPending(
          exceptionName
        )
    ...
    describe("#isExceptionRequestWithArgsPending") {
      it("should return false if no requests exist") {
        ...
        val actual = javaExceptionProfile.isExceptionRequestWithArgsPending(
          exceptionName,
          notifyCaught,
          notifyUncaught,
          extraArguments: _*
