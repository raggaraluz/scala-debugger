...
class PureLocatableEventInfoSpec extends test.ParallelMockFunSpec {
  ...
  private val pureLocatableEventInfoProfile = new PureLocatableEventInfo(
  ...
  describe("PureLocatableEventInfo") {
    describe("#toJavaInfo") {
