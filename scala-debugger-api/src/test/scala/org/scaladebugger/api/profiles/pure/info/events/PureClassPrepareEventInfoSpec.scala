...
class PureClassPrepareEventInfoSpec extends ParallelMockFunSpec {
  ...
  private val pureClassPrepareEventInfoProfile = new PureClassPrepareEventInfo(
  ...
  describe("PureClassPrepareEventInfo") {
    describe("#toJavaInfo") {
