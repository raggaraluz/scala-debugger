...
class JavaMonitorContendedEnterEventInfoSpec extends ParallelMockFunSpec {
  ...
  private val javaMonitorContendedEnterEventInfoProfile = new JavaMonitorContendedEnterEventInfo(
  ...
  describe("JavaMonitorContendedEnterEventInfo") {
    describe("#toJavaInfo") {
      it("should return a new instance of the Java profile representation") {
        ...
        (mockEventInfoProducer.newMonitorContendedEnterEventInfo(
        ...
        val actual = javaMonitorContendedEnterEventInfoProfile.toJavaInfo
    ...
    describe("#isJavaInfo") {
      it("should return true") {
        ...
        val actual = javaMonitorContendedEnterEventInfoProfile.isJavaInfo
    ...
    describe("#toJdiInstance") {
      it("should return the JDI instance this profile instance represents") {
        ...
        val actual = javaMonitorContendedEnterEventInfoProfile.toJdiInstance
