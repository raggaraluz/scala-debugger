...
class JavaThreadDeathRequestSpec extends ParallelMockFunSpec with JDIMockHelpers {
  ...
  private val javaThreadDeathProfile =
    new TestJavaThreadDeathRequest(Some(mockRequestHelper))
  ...
  describe("JavaThreadDeathRequest") {
    describe("for custom request helper") {
      describe("#_newRequestId") {
        it("should return a new id each time") {
          val javaThreadDeathProfile = new TestJavaThreadDeathRequest()
          val requestHelper = javaThreadDeathProfile.newThreadDeathRequestHelper()
    ...
    describe("#tryGetOrCreateThreadDeathRequestWithData") {
      it("should use the request helper's request and event pipeline methods") {
        ...
        val actual = javaThreadDeathProfile.tryGetOrCreateThreadDeathRequest(
    ...
    describe("#threadDeathRequests") {
      it("should include all active requests") {
        ...
        val javaThreadDeathProfile = new Object with JavaThreadDeathRequest {
          override protected val threadDeathManager = mockThreadDeathManager
          override protected val eventManager: EventManager = mockEventManager
          override protected val infoProducer: InfoProducer = mockInfoProducer
          override protected val scalaVirtualMachine: ScalaVirtualMachine = mockScalaVirtualMachine
        ...
        val actual = javaThreadDeathProfile.threadDeathRequests
    ...
    describe("#removeThreadDeathRequestWithArgs") {
      it("should return None if no requests exists") {
        ...
        val actual = javaThreadDeathProfile.removeThreadDeathRequestWithArgs()
    ...
    describe("#removeAllThreadDeathRequests") {
      it("should return empty if no requests exists") {
        ...
        val actual = javaThreadDeathProfile.removeAllThreadDeathRequests()
    ...
    describe("#isThreadDeathRequestWithArgsPending") {
      it("should return false if no requests exist") {
        ...
        val actual = javaThreadDeathProfile.isThreadDeathRequestWithArgsPending()
