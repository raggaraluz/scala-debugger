...
class PureMonitorContendedEnteredEventInfoSpec extends ParallelMockFunSpec {
  ...
  private val pureMonitorContendedEnteredEventInfoProfile = new PureMonitorContendedEnteredEventInfo(
  ...
  describe("PureMonitorContendedEnteredEventInfo") {
    describe("#toJavaInfo") {
