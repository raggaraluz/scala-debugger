...
class JavaGrabInfoSpec extends ParallelMockFunSpec
{
  ...
  private val javaGrabInfoProfile = new JavaGrabInfoProfile {
  ...
  describe("JavaGrabInfoProfile") {
    describe("#`object`") {
      it("should return a java object info profile wrapping the object") {
        ...
        val actual = javaGrabInfoProfile.`object`(mockObjectReference)
    ...
    describe("#threads") {
      it("should return a collection of profiles wrapping class reference types") {
        ...
        val actual = javaGrabInfoProfile.threads
    ...
    describe("#thread(threadReference)") {
      it("should return a java thread info profile wrapping the thread") {
        ...
        val actual = javaGrabInfoProfile.thread(mockThreadReference)
    ...
    describe("#threadGroups") {
      it("should return a collection of profiles wrapping class reference types") {
        ...
        val actual = javaGrabInfoProfile.threadGroups
    ...
    describe("#threadGroup(threadGroupReference)") {
      it("should return a java threadGroup info profile wrapping the threadGroup") {
        ...
        val actual = javaGrabInfoProfile.threadGroup(mockThreadGroupReference)
    ...
    describe("#classes") {
      it("should return a collection of profiles wrapping class reference types") {
        ...
        val actual = javaGrabInfoProfile.classes
    ...
    describe("#`class`") {
      it("should return a reference type info profile wrapping the reference type") {
        ...
        val actual = javaGrabInfoProfile.`class`(mockReferenceType)
    ...
    describe("#location") {
      it("should return a location info profile wrapping the location") {
        ...
        val actual = javaGrabInfoProfile.location(mockLocation)
    ...
    describe("#`type`") {
      it("should return a type info profile wrapping the type") {
        ...
        val actual = javaGrabInfoProfile.`type`(mockType)
    ...
    describe("#field(reference type, field)") {
      it("should return a variable info profile wrapping the field") {
        ...
        val actual = javaGrabInfoProfile.field(mockReferenceType, mockField)
    ...
    describe("#field(object reference, field)") {
      it("should return a variable info profile wrapping the field") {
        ...
        val actual = javaGrabInfoProfile.field(mockObjectReference, mockField)
    ...
    describe("#localVariable") {
      it("should return a variable info profile wrapping the local variable") {
        ...
        val actual = javaGrabInfoProfile.localVariable(
          mockStackFrame,
          mockLocalVariable
        )
    ...
    describe("#stackFrame") {
      it("should return a frame info profile wrapping the stack frame") {
        ...
        val actual = javaGrabInfoProfile.stackFrame(mockStackFrame)
    ...
    describe("#method") {
      it("should return a method info profile wrapping the method") {
        ...
        val actual = javaGrabInfoProfile.method(mockMethod)
    ...
    describe("#value") {
      it("should return a value info profile wrapping the value") {
        ...
        val actual = javaGrabInfoProfile.value(mockValue)
