...
class PureWatchpointEventInfoSpec extends test.ParallelMockFunSpec {
  ...
  private val pureWatchpointEventInfoProfile = new PureWatchpointEventInfo(
  ...
  describe("PureWatchpointEventInfo") {
    describe("#toJavaInfo") {
