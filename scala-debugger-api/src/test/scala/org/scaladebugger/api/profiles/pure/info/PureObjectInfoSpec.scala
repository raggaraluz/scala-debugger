...
class PureObjectInfoSpec extends test.ParallelMockFunSpec
{
  ...
  private val pureObjectInfoProfile = new PureObjectInfo(
  ...
  describe("PureObjectInfo") {
    ...
    describe("#isJavaInfo") {
      it("should return true") {
        ...
        val actual = pureObjectInfoProfile.isJavaInfo
    ...
    describe("#invoke(thread profile, method profile, arguments, JDI arguments)") {
      it("should invoke using the provided thread and method, returning wrapper profile of value") {
        ...
        val pureMethodInfoProfile = new PureMethodInfo(
          mockScalaVirtualMachine,
          mockInfoProducerProfile,
          mockMethod
        )
