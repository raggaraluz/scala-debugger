...
class PureMonitorWaitedEventInfoProfileSpec extends test.ParallelMockFunSpec {
  ...
  private val pureMonitorWaitedEventInfoProfile = new PureMonitorWaitedEventInfoProfile(
  ...
  describe("PureMonitorWaitedEventInfoProfile") {
    describe("#toJavaInfo") {
      it("should return a new instance of the Java profile representation") {
        ...
        val actual = pureMonitorWaitedEventInfoProfile.toJavaInfo
    ...
    describe("#isJavaInfo") {
      it("should return true") {
        ...
        val actual = pureMonitorWaitedEventInfoProfile.isJavaInfo
    ...
    describe("#toJdiInstance") {
      it("should return the JDI instance this profile instance represents") {
        ...
        val actual = pureMonitorWaitedEventInfoProfile.toJdiInstance
