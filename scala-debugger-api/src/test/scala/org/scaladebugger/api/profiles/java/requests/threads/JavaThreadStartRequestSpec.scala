...
class JavaThreadStartRequestSpec extends ParallelMockFunSpec with JDIMockHelpers {
  ...
  private val javaThreadStartProfile =
    new TestJavaThreadStartRequest(Some(mockRequestHelper))
  ...
  describe("JavaThreadStartRequest") {
    describe("for custom request helper") {
      describe("#_newRequestId") {
        it("should return a new id each time") {
          val javaThreadStartProfile = new TestJavaThreadStartRequest()
          val requestHelper = javaThreadStartProfile.newThreadStartRequestHelper()
    ...
    describe("#tryGetOrCreateThreadStartRequestWithData") {
      it("should use the request helper's request and event pipeline methods") {
        ...
        val actual = javaThreadStartProfile.tryGetOrCreateThreadStartRequest(
    ...
    describe("#threadStartRequests") {
      it("should include all active requests") {
        ...
        val javaThreadStartProfile = new Object with JavaThreadStartRequest {
          override protected val threadStartManager = mockThreadStartManager
          override protected val eventManager: EventManager = mockEventManager
          override protected val infoProducer: InfoProducer = mockInfoProducer
          override protected val scalaVirtualMachine: ScalaVirtualMachine = mockScalaVirtualMachine
        ...
        val actual = javaThreadStartProfile.threadStartRequests
    ...
    describe("#removeThreadStartRequestWithArgs") {
      it("should return None if no requests exists") {
        ...
        val actual = javaThreadStartProfile.removeThreadStartRequestWithArgs()
    ...
    describe("#removeAllThreadStartRequests") {
      it("should return empty if no requests exists") {
        ...
        val actual = javaThreadStartProfile.removeAllThreadStartRequests()
    ...
    describe("#isThreadStartRequestWithArgsPending") {
      it("should return false if no requests exist") {
        ...
        val actual = javaThreadStartProfile.isThreadStartRequestWithArgsPending()
