...
class JavaMethodEntryEventInfoSpec extends ParallelMockFunSpec {
  ...
  private val javaMethodEntryEventInfoProfile = new JavaMethodEntryEventInfo(
  ...
  describe("JavaMethodEntryEventInfo") {
    describe("#toJavaInfo") {
      it("should return a new instance of the Java profile representation") {
        ...
        val actual = javaMethodEntryEventInfoProfile.toJavaInfo
    ...
    describe("#isJavaInfo") {
      it("should return true") {
        ...
        val actual = javaMethodEntryEventInfoProfile.isJavaInfo
    ...
    describe("#toJdiInstance") {
      it("should return the JDI instance this profile instance represents") {
        ...
        val actual = javaMethodEntryEventInfoProfile.toJdiInstance
    ...
    describe("#method") {
      it("should return a new method info profile for the jdi method") {
        ...
        val actual = javaMethodEntryEventInfoProfile.method
