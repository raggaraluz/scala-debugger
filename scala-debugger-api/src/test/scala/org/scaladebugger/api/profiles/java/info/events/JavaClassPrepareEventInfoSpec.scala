...
class JavaClassPrepareEventInfoSpec extends ParallelMockFunSpec {
  ...
  private val javaClassPrepareEventInfoProfile = new JavaClassPrepareEventInfo(
  ...
  describe("JavaClassPrepareEventInfo") {
    describe("#toJavaInfo") {
      it("should return a new instance of the Java profile representation") {
        ...
        (mockEventInfoProducer.newClassPrepareEventInfo(
        ...
        val actual = javaClassPrepareEventInfoProfile.toJavaInfo
    ...
    describe("#isJavaInfo") {
      it("should return true") {
        ...
        val actual = javaClassPrepareEventInfoProfile.isJavaInfo
    ...
    describe("#toJdiInstance") {
      it("should return the JDI instance this profile instance represents") {
        ...
        val actual = javaClassPrepareEventInfoProfile.toJdiInstance
    ...
    describe("#thread") {
      it("should return a new instance of the thread info profile") {
        ...
        val actual = javaClassPrepareEventInfoProfile.thread
    ...
    describe("#referenceType") {
      it("should return a new instance of the reference type info profile") {
        ...
        // NOTE: Cannot validate second set of args because they are
        //       call-by-name, which ScalaMock does not support presently
        (mockInfoProducer.newReferenceTypeInfo(
          _: ScalaVirtualMachine,
          _: ReferenceType
        )).expects(
          mockScalaVirtualMachine,
        ...
        val actual = javaClassPrepareEventInfoProfile.referenceType
