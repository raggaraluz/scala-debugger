...
class PureVMDisconnectEventInfoProfileSpec extends test.ParallelMockFunSpec {
  ...
  private val pureVMDisconnectEventInfoProfile = new PureVMDisconnectEventInfoProfile(
  ...
  describe("PureVMDisconnectEventInfoProfile") {
    describe("#toJavaInfo") {
