...
class JavaMonitorContendedEnteredRequestSpec extends ParallelMockFunSpec with JDIMockHelpers {
  ...
  private class TestJavaMonitorContendedEnteredRequest(
    private val customTestRequestHelper: Option[CustomTestRequestHelper] = None
  ) extends JavaMonitorContendedEnteredRequest {
  ...
  private val javaMonitorContendedEnteredProfile =
    new TestJavaMonitorContendedEnteredRequest(Some(mockRequestHelper))
  ...
  describe("JavaMonitorContendedEnteredRequest") {
    describe("for custom request helper") {
      describe("#_newRequestId") {
        it("should return a new id each time") {
          val javaMonitorContendedEnteredProfile = new TestJavaMonitorContendedEnteredRequest()
          val requestHelper = javaMonitorContendedEnteredProfile.newMonitorContendedEnteredRequestHelper()
    ...
    describe("#tryGetOrCreateMonitorContendedEnteredRequestWithData") {
      it("should use the request helper's request and event pipeline methods") {
        ...
        val actual = javaMonitorContendedEnteredProfile.tryGetOrCreateMonitorContendedEnteredRequest(
    ...
    describe("#monitorContendedEnteredRequests") {
      it("should include all active requests") {
        ...
        val javaMonitorContendedEnteredProfile = new Object with JavaMonitorContendedEnteredRequest {
          override protected val monitorContendedEnteredManager = mockMonitorContendedEnteredManager
          override protected val eventManager: EventManager = mockEventManager
          override protected val infoProducer: InfoProducer = mockInfoProducer
          override protected val scalaVirtualMachine: ScalaVirtualMachine = mockScalaVirtualMachine
        ...
        val actual = javaMonitorContendedEnteredProfile.monitorContendedEnteredRequests
    ...
    describe("#removeMonitorContendedEnteredRequestWithArgs") {
      it("should return None if no requests exists") {
        ...
        val actual = javaMonitorContendedEnteredProfile.removeMonitorContendedEnteredRequestWithArgs()
    ...
    describe("#removeAllMonitorContendedEnteredRequests") {
      it("should return empty if no requests exists") {
        ...
        val actual = javaMonitorContendedEnteredProfile.removeAllMonitorContendedEnteredRequests()
    ...
    describe("#isMonitorContendedEnteredRequestWithArgsPending") {
      it("should return false if no requests exist") {
        ...
        val actual = javaMonitorContendedEnteredProfile.isMonitorContendedEnteredRequestWithArgsPending()
