...
class JavaMonitorContendedEnteredEventInfoSpec extends ParallelMockFunSpec {
  ...
  private val javaMonitorContendedEnteredEventInfoProfile = new JavaMonitorContendedEnteredEventInfo(
  ...
  describe("JavaMonitorContendedEnteredEventInfo") {
    describe("#toJavaInfo") {
      it("should return a new instance of the Java profile representation") {
        ...
        (mockEventInfoProducer.newMonitorContendedEnteredEventInfo(
        ...
        val actual = javaMonitorContendedEnteredEventInfoProfile.toJavaInfo
    ...
    describe("#isJavaInfo") {
      it("should return true") {
        ...
        val actual = javaMonitorContendedEnteredEventInfoProfile.isJavaInfo
    ...
    describe("#toJdiInstance") {
      it("should return the JDI instance this profile instance represents") {
        ...
        val actual = javaMonitorContendedEnteredEventInfoProfile.toJdiInstance
