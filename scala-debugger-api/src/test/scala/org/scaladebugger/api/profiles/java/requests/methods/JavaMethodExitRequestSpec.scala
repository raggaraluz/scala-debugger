...
class JavaMethodExitRequestSpec extends ParallelMockFunSpec with JDIMockHelpers {
  ...
  private val javaMethodExitProfile =
    new TestJavaMethodExitRequest(Some(mockRequestHelper))
  ...
  describe("JavaMethodExitRequest") {
    describe("for custom request helper") {
      describe("#_newRequestId") {
        it("should return a new id each time") {
          val javaMethodExitProfile = new TestJavaMethodExitRequest()
          val requestHelper = javaMethodExitProfile.newMethodExitRequestHelper()
    ...
    describe("#tryGetOrCreateMethodExitRequestWithData") {
      it("should use the request helper's request and event pipeline methods") {
        ...
        val actual = javaMethodExitProfile.tryGetOrCreateMethodExitRequest(
          className,
          methodName,
    ...
    describe("#methodExitRequests") {
      it("should include all active requests") {
        ...
        val javaMethodExitProfile = new Object with JavaMethodExitRequest {
          override protected val methodExitManager = mockMethodExitManager
          override protected val eventManager: EventManager = mockEventManager
          override protected val infoProducer: InfoProducer = mockInfoProducer
          override protected val scalaVirtualMachine: ScalaVirtualMachine = mockScalaVirtualMachine
        ...
        val actual = javaMethodExitProfile.methodExitRequests
    ...
    describe("#removeMethodExitRequests") {
      it("should return empty if no requests exists") {
        ...
        val actual = javaMethodExitProfile.removeMethodExitRequests(
          className,
          methodName
        )
    ...
    describe("#removeMethodExitRequestWithArgs") {
      it("should return None if no requests exists") {
        ...
        val actual = javaMethodExitProfile.removeMethodExitRequestWithArgs(
          className,
          methodName
        )
    ...
    describe("#removeAllMethodExitRequests") {
      it("should return empty if no requests exists") {
        ...
        val actual = javaMethodExitProfile.removeAllMethodExitRequests()
    ...
    describe("#isMethodExitRequestPending") {
      it("should return false if no requests exist") {
        ...
        val actual = javaMethodExitProfile.isMethodExitRequestPending(
          className,
          methodName
        )
    ...
    describe("#isMethodExitRequestWithArgsPending") {
      it("should return false if no requests exist") {
        ...
        val actual = javaMethodExitProfile.isMethodExitRequestWithArgsPending(
          className,
          methodName
        )
