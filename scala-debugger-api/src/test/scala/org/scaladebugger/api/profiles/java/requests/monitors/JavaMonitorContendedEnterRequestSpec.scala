...
class JavaMonitorContendedEnterRequestSpec extends ParallelMockFunSpec with JDIMockHelpers {
  ...
  private class TestJavaMonitorContendedEnterRequest(
    private val customTestRequestHelper: Option[CustomTestRequestHelper] = None
  ) extends JavaMonitorContendedEnterRequest {
  ...
  private val javaMonitorContendedEnterProfile =
    new TestJavaMonitorContendedEnterRequest(Some(mockRequestHelper))
  ...
  describe("JavaMonitorContendedEnterRequest") {
    describe("for custom request helper") {
      describe("#_newRequestId") {
        it("should return a new id each time") {
          val javaMonitorContendedEnterProfile = new TestJavaMonitorContendedEnterRequest()
          val requestHelper = javaMonitorContendedEnterProfile.newMonitorContendedEnterRequestHelper()
    ...
    describe("#tryGetOrCreateMonitorContendedEnterRequestWithData") {
      it("should use the request helper's request and event pipeline methods") {
        ...
        val actual = javaMonitorContendedEnterProfile.tryGetOrCreateMonitorContendedEnterRequest(
    ...
    describe("#monitorContendedEnterRequests") {
      it("should include all active requests") {
        ...
        val javaMonitorContendedEnterProfile = new Object with JavaMonitorContendedEnterRequest {
          override protected val monitorContendedEnterManager = mockMonitorContendedEnterManager
          override protected val eventManager: EventManager = mockEventManager
          override protected val infoProducer: InfoProducer = mockInfoProducer
          override protected val scalaVirtualMachine: ScalaVirtualMachine = mockScalaVirtualMachine
        ...
        val actual = javaMonitorContendedEnterProfile.monitorContendedEnterRequests
    ...
    describe("#removeMonitorContendedEnterRequestWithArgs") {
      it("should return None if no requests exists") {
        ...
        val actual = javaMonitorContendedEnterProfile.removeMonitorContendedEnterRequestWithArgs()
    ...
    describe("#removeAllMonitorContendedEnterRequests") {
      it("should return empty if no requests exists") {
        ...
        val actual = javaMonitorContendedEnterProfile.removeAllMonitorContendedEnterRequests()
    ...
    describe("#isMonitorContendedEnterRequestWithArgsPending") {
      it("should return false if no requests exist") {
        ...
        val actual = javaMonitorContendedEnterProfile.isMonitorContendedEnterRequestWithArgsPending()
