...
class JavaMethodEntryRequestSpec extends ParallelMockFunSpec with JDIMockHelpers {
  ...
  private val javaMethodEntryProfile =
    new TestJavaMethodEntryRequest(Some(mockRequestHelper))
  ...
  describe("JavaMethodEntryRequest") {
    describe("for custom request helper") {
      describe("#_newRequestId") {
        it("should return a new id each time") {
          val javaMethodEntryProfile = new TestJavaMethodEntryRequest()
          val requestHelper = javaMethodEntryProfile.newMethodEntryRequestHelper()
    ...
    describe("#tryGetOrCreateMethodEntryRequestWithData") {
      it("should use the request helper's request and event pipeline methods") {
        ...
        val actual = javaMethodEntryProfile.tryGetOrCreateMethodEntryRequest(
          className,
          methodName,
    ...
    describe("#methodEntryRequests") {
      it("should include all active requests") {
        ...
        val javaMethodEntryProfile = new Object with JavaMethodEntryRequest {
          override protected val methodEntryManager = mockMethodEntryManager
          override protected val eventManager: EventManager = mockEventManager
          override protected val infoProducer: InfoProducer = mockInfoProducer
          override protected val scalaVirtualMachine: ScalaVirtualMachine = mockScalaVirtualMachine
        ...
        val actual = javaMethodEntryProfile.methodEntryRequests
    ...
    describe("#removeMethodEntryRequests") {
      it("should return empty if no requests exists") {
        ...
        val actual = javaMethodEntryProfile.removeMethodEntryRequests(
          className,
          methodName
        )
    ...
    describe("#removeMethodEntryRequestWithArgs") {
      it("should return None if no requests exists") {
        ...
        val actual = javaMethodEntryProfile.removeMethodEntryRequestWithArgs(
          className,
          methodName
        )
    ...
    describe("#removeAllMethodEntryRequests") {
      it("should return empty if no requests exists") {
        ...
        val actual = javaMethodEntryProfile.removeAllMethodEntryRequests()
    ...
    describe("#isMethodEntryRequestPending") {
      it("should return false if no requests exist") {
        ...
        val actual = javaMethodEntryProfile.isMethodEntryRequestPending(
          className,
          methodName
        )
    ...
    describe("#isMethodEntryRequestWithArgsPending") {
      it("should return false if no requests exist") {
        ...
        val actual = javaMethodEntryProfile.isMethodEntryRequestWithArgsPending(
          className,
          methodName
        )
