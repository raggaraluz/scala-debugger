...
class PureThreadDeathEventInfoProfileSpec extends test.ParallelMockFunSpec {
  ...
  private val pureThreadDeathEventInfoProfile = new PureThreadDeathEventInfoProfile(
  ...
  describe("PureThreadDeathEventInfoProfile") {
    describe("#toJavaInfo") {
