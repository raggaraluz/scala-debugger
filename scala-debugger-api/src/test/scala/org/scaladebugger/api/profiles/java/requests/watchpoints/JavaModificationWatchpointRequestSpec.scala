...
class JavaModificationWatchpointRequestSpec extends ParallelMockFunSpec with JDIMockHelpers
{
  ...
  private class TestJavaModificationWatchpointRequest(
    private val customTestRequestHelper: Option[CustomTestRequestHelper] = None
  ) extends JavaModificationWatchpointRequest {
  ...
  private val javaModificationWatchpointProfile =
    new TestJavaModificationWatchpointRequest(Some(mockRequestHelper))
  ...
  describe("JavaModificationWatchpointRequest") {
    describe("for custom request helper") {
      describe("#_newRequestId") {
        it("should return a new id each time") {
          val javaModificationWatchpointProfile = new TestJavaModificationWatchpointRequest()
          val requestHelper = javaModificationWatchpointProfile.newModificationWatchpointRequestHelper()
    ...
    describe("#tryGetOrCreateModificationWatchpointRequestWithData") {
      it("should use the request helper's request and event pipeline methods") {
        ...
        val actual = javaModificationWatchpointProfile.tryGetOrCreateModificationWatchpointRequest(
          className,
          fieldName,
    ...
    describe("#modificationWatchpointRequests") {
      it("should include all active requests") {
        ...
        val javaModificationWatchpointProfile = new Object with JavaModificationWatchpointRequest {
          override protected val modificationWatchpointManager = mockModificationWatchpointManager
          override protected val eventManager: EventManager = mockEventManager
          override protected val infoProducer: InfoProducer = mockInfoProducer
          override protected val scalaVirtualMachine: ScalaVirtualMachine = mockScalaVirtualMachine
        ...
        val actual = javaModificationWatchpointProfile.modificationWatchpointRequests
    ...
    describe("#removeModificationWatchpointRequests") {
      it("should return empty if no requests exists") {
        ...
        val actual = javaModificationWatchpointProfile.removeModificationWatchpointRequests(
          className,
          fieldName
        )
    ...
    describe("#removeModificationWatchpointRequestWithArgs") {
      it("should return None if no requests exists") {
        ...
        val actual = javaModificationWatchpointProfile.removeModificationWatchpointRequestWithArgs(
          className,
          fieldName
        )
    ...
    describe("#removeAllModificationWatchpointRequests") {
      it("should return empty if no requests exists") {
        ...
        val actual = javaModificationWatchpointProfile.removeAllModificationWatchpointRequests()
    ...
    describe("#isModificationWatchpointRequestPending") {
      it("should return false if no requests exist") {
        ...
        val actual = javaModificationWatchpointProfile.isModificationWatchpointRequestPending(
          className,
          fieldName
        )
    ...
    describe("#isModificationWatchpointRequestWithArgsPending") {
      it("should return false if no requests exist") {
        ...
        val actual = javaModificationWatchpointProfile.isModificationWatchpointRequestWithArgsPending(
          className,
          fieldName
        )
