...
class JavaClassUnloadRequestSpec extends ParallelMockFunSpec with JDIMockHelpers {
  ...
  private val javaClassUnloadProfile =
    new TestJavaClassUnloadRequest(Some(mockRequestHelper))
  ...
  describe("JavaClassUnloadRequest") {
    describe("for custom request helper") {
      describe("#_newRequestId") {
        it("should return a new id each time") {
          val javaClassUnloadProfile = new TestJavaClassUnloadRequest()
          val requestHelper = javaClassUnloadProfile.newClassUnloadRequestHelper()
    ...
    describe("#tryGetOrCreateClassUnloadRequestWithData") {
      it("should use the request helper's request and event pipeline methods") {
        ...
        val actual = javaClassUnloadProfile.tryGetOrCreateClassUnloadRequest(
    ...
    describe("#classUnloadRequests") {
      it("should include all active requests") {
        ...
        val javaClassUnloadProfile = new Object with JavaClassUnloadRequest {
          override protected val classUnloadManager = mockClassUnloadManager
          override protected val eventManager: EventManager = mockEventManager
          override protected val infoProducer: InfoProducer = mockInfoProducer
          override protected val scalaVirtualMachine: ScalaVirtualMachine = mockScalaVirtualMachine
        ...
        val actual = javaClassUnloadProfile.classUnloadRequests
    ...
    describe("#removeClassUnloadRequestWithArgs") {
      it("should return None if no requests exists") {
        ...
        val actual = javaClassUnloadProfile.removeClassUnloadRequestWithArgs()
    ...
    describe("#removeAllClassUnloadRequests") {
      it("should return empty if no requests exists") {
        ...
        val actual = javaClassUnloadProfile.removeAllClassUnloadRequests()
    ...
    describe("#isClassUnloadRequestWithArgsPending") {
      it("should return false if no requests exist") {
        ...
        val actual = javaClassUnloadProfile.isClassUnloadRequestWithArgsPending()
