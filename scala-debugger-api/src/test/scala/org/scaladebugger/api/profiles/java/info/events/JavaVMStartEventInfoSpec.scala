...
class JavaVMStartEventInfoSpec extends ParallelMockFunSpec {
  ...
  private val javaVMStartEventInfoProfile = new JavaVMStartEventInfo(
  ...
  describe("JavaVMStartEventInfo") {
    describe("#toJavaInfo") {
      it("should return a new instance of the Java profile representation") {
        ...
        val actual = javaVMStartEventInfoProfile.toJavaInfo
    ...
    describe("#isJavaInfo") {
      it("should return true") {
        ...
        val actual = javaVMStartEventInfoProfile.isJavaInfo
    ...
    describe("#toJdiInstance") {
      it("should return the JDI instance this profile instance represents") {
        ...
        val actual = javaVMStartEventInfoProfile.toJdiInstance
    ...
    describe("#thread") {
      it("should return a new instance of the thread info profile") {
        ...
        val actual = javaVMStartEventInfoProfile.thread
