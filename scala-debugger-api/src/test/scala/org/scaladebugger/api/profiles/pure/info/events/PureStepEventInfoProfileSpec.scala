...
class PureStepEventInfoProfileSpec extends test.ParallelMockFunSpec {
  ...
  private val pureStepEventInfoProfile = new PureStepEventInfoProfile(
  ...
  describe("PureStepEventInfoProfile") {
    describe("#toJavaInfo") {
