...
class JavaStepRequestSpec extends ParallelMockFunSpec with JDIMockHelpers with Futures
  with ScalaFutures
{
  ...
  private val javaStepProfile = new Object with JavaStepRequest {
  ...
  describe("JavaStepRequest") {
    describe("#stepRequests") {
      it("should include all active requests") {
        ...
        val javaStepProfile = new Object with JavaStepRequest {
          override protected val stepManager = mockStepManager
        ...
        val actual = javaStepProfile.stepRequests
    ...
    describe("#removeStepRequests") {
      it("should return empty if no requests exists") {
        ...
        val actual = javaStepProfile.removeStepRequests(
          threadInfoProfile
        )
    ...
    describe("#removeStepRequestWithArgs") {
      it("should return None if no requests exists") {
        ...
        val actual = javaStepProfile.removeStepRequestWithArgs(
          threadInfoProfile
        )
    ...
    describe("#removeAllStepRequests") {
      it("should return empty if no requests exists") {
        ...
        val actual = javaStepProfile.removeAllStepRequests()
    ...
    describe("#isStepRequestPending") {
      it("should return false if no requests exist") {
        ...
        val actual = javaStepProfile.isStepRequestPending(threadInfoProfile)
      ...
      it("should return false if no request with matching thread exists") {
        ...
        val actual = javaStepProfile.isStepRequestPending(mockThreadInfoProfile)
    ...
    describe("#isStepRequestWithArgsPending") {
      it("should return false if no requests exist") {
        ...
        val actual = javaStepProfile.isStepRequestWithArgsPending(
          threadInfoProfile,
          extraArguments: _*
        )
    ...
    describe("#stepIntoLineWithData") {
      it("should create a new step request and pipeline whose future is returned") {
        ...
        val stepFuture = javaStepProfile.stepIntoLineWithData(
          mockThreadInfoProfile,
          rArgs ++ eArgs: _*
        )
    ...
    describe("#stepOutLineWithData") {
      it("should create a new step request and pipeline whose future is returned") {
        ...
        val stepFuture = javaStepProfile.stepOutLineWithData(
          mockThreadInfoProfile,
          rArgs ++ eArgs: _*
        )
    ...
    describe("#stepOverLineWithData") {
      it("should create a new step request and pipeline whose future is returned") {
        ...
        val stepFuture = javaStepProfile.stepOverLineWithData(
          mockThreadInfoProfile,
          rArgs ++ eArgs: _*
        )
    ...
    describe("#stepIntoMinWithData") {
      it("should create a new step request and pipeline whose future is returned") {
        ...
        val stepFuture = javaStepProfile.stepIntoMinWithData(
          mockThreadInfoProfile,
          rArgs ++ eArgs: _*
        )
    ...
    describe("#stepOutMinWithData") {
      it("should create a new step request and pipeline whose future is returned") {
        ...
        val stepFuture = javaStepProfile.stepOutMinWithData(
          mockThreadInfoProfile,
          rArgs ++ eArgs: _*
        )
    ...
    describe("#stepOverMinWithData") {
      it("should create a new step request and pipeline whose future is returned") {
        ...
        val stepFuture = javaStepProfile.stepOverMinWithData(
          mockThreadInfoProfile,
          rArgs ++ eArgs: _*
        )
    ...
    describe("#tryCreateStepListenerWithData") {
      it("should create a stream of events with data for steps") {
        ...
        val pipeline = javaStepProfile.tryCreateStepListenerWithData(
