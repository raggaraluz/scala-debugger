...
object InfoTestClasses {
  ...
  class TestThreadInfo extends TestObjectInfo with ThreadInfo {
    ...
    override def typeInfo: ReferenceTypeInfo = throwException()
  ...
  class TestValueInfo extends ValueInfo {
    ...
    override def isJavaInfo: Boolean = throwException()
    override def typeInfo: TypeInfo = throwException()
    override def scalaVirtualMachine: ScalaVirtualMachine = throwException()
  ...
  class TestMethodInfo extends MethodInfo {
    ...
    override def isJavaInfo: Boolean = throwException()
    override def parameterTypeInfo: Seq[TypeInfo] = throwException()
    override def returnTypeInfo: TypeInfo = throwException()
    override def declaringTypeInfo: ReferenceTypeInfo = throwException()
    override def scalaVirtualMachine: ScalaVirtualMachine = throwException()
    override def name: String = throwException()
  ...
  class TestArrayInfo extends TestObjectInfo with ArrayInfo with TestCreateInfoProfileTrait {
    ...
    override def typeInfo: ArrayTypeInfo = throwException()
    override def scalaVirtualMachine: ScalaVirtualMachine = throwException()
  ...
  class TestPrimitiveInfo extends TestValueInfo with PrimitiveInfo {
    ...
    override def isJavaInfo: Boolean = throwException()
    override def typeInfo: PrimitiveTypeInfo = throwException()
    override def scalaVirtualMachine: ScalaVirtualMachine = throwException()
