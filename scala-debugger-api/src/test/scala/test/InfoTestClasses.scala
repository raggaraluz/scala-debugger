...
object InfoTestClasses {
  ...
  class TestGrabInfoProfile extends GrabInfoProfile {
    ...
    override def field(referenceType: ReferenceType, field: Field): FieldVariableInfoProfile = throwException()
    override def field(objectReference: ObjectReference, field: Field): FieldVariableInfoProfile = throwException()
  ...
  class TestFrameInfoProfile extends FrameInfoProfile {
    ...
    override def indexedFieldVariables: Seq[FieldVariableInfoProfile] = throwException()
    ...
    override def fieldVariables: Seq[FieldVariableInfoProfile] = throwException()
  ...
  class TestReferenceTypeInfoProfile extends TestTypeInfoProfile with ReferenceTypeInfoProfile {
    ...
    override def indexedVisibleFields: Seq[FieldVariableInfoProfile] = throwException()
    override def scalaVirtualMachine: ScalaVirtualMachine = throwException()
    ...
    override def visibleFields: Seq[FieldVariableInfoProfile] = throwException()
    override def name: String = throwException()
    ...
    override def allFields: Seq[FieldVariableInfoProfile] = throwException()
